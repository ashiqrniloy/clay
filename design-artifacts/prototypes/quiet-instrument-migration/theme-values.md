...
| Role | Current value | Current on canvas | Proposed | Proposed on canvas | Composited vs canvas |
| --- | --- | --- | --- | --- | --- |
| `border.hairline` | `#928374aa` | `#6f655bff` | `#92837457` | `#4c4742ff` | 1.61:1 |
| `border.subtle` | `#928374aa` | `#6f655bff` | `#928374` | `#928374ff` | 4.02:1 |
| `border.strong` | `#928374aa` | `#6f655bff` | `#d4be98` | `#d4be98ff` | 8.16:1 |
| `surface.hover` | `#7daea333` | `#394341ff` | `#3c3836` | `#3c3836ff` | 1.27:1 |
| `surface.active` | `#7daea333` | `#394341ff` | `#45403d` | `#45403dff` | 1.44:1 |
| `surface.selected` | `#7daea333` | `#394341ff` | `#3a4438` | `#3a4438ff` | 1.45:1 |
...
Depth direction (`DESIGN.md` §10.2): chrome `#1d2021`, canvas `#282828` — canvas is lighter, as required. Composed depth step 1.11:1 (today 1.11:1).
...
| Pair | Floor | Current | Proposed | |
| --- | --- | --- | --- | --- |
| `text.muted on surface.panel` | 4.5:1 | 9.07:1 | 6.57:1 | ok |
| `text.disabled on surface.main` | 4.5:1 | 3.03:1 (fails today) | 5.56:1 | ok |
| `accent.primary on surface.main` | 3.0:1 | 8.16:1 | 5.94:1 | ok |
| `accent.muted on surface.main` | 3.0:1 | 3.03:1 | 3.98:1 | ok |
| `focus.ring on surface.main` | 3.0:1 | 8.16:1 | 5.94:1 | ok |
| `border.focus on surface.main` | 3.0:1 | 8.16:1 | 5.94:1 | ok |
| `border.subtle on surface.main` | 3.0:1 | 2.59:1 (fails today) | 4.02:1 | ok |
| `border.subtle on surface.panel` | 3.0:1 | 2.74:1 (fails today) | 4.47:1 | ok |
| `border.strong on surface.main` | 3.0:1 | 2.59:1 (fails today) | 8.16:1 | ok |
