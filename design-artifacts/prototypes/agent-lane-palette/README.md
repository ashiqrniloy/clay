...
> **Approved 2026-09-17.** This directory is the working copy; the frozen
> snapshot is at `design-artifacts/approved/agent-lane-palette/` (with per-file
> hashes and the approval record). Iteration continues here; a change that
