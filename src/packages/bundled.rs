...
pub(crate) const BUNDLED_PACKAGES: &[BundledPackageEntry] = &[
    BundledPackageEntry {
        ...
        version: "0.1.0",
        root: "git",
        manifest_fingerprint: "e415a8b58d3c0d95",
    },
    BundledPackageEntry {
        name: "@clay/javascript",
        version: "0.1.0",
        root: "javascript",
        manifest_fingerprint: "e6b90a8c6ec9a1be",
    },
    BundledPackageEntry {
        name: "@clay/lsp-javascript",
        version: "0.1.0",
        root: "lsp-javascript",
        manifest_fingerprint: "ef740a750f4fe295",
    },
    BundledPackageEntry {
        name: "@clay/lsp-markdown",
        version: "0.1.0",
        root: "lsp-markdown",
        manifest_fingerprint: "e56d14706ba6b210",
    },
    BundledPackageEntry {
        name: "@clay/lsp-rust",
        version: "0.1.0",
        root: "lsp-rust",
        manifest_fingerprint: "1b295215cd5c69f1",
    },
    BundledPackageEntry {
        name: "@clay/lsp-typescript",
        version: "0.1.0",
        root: "lsp-typescript",
        manifest_fingerprint: "1272dbef963c40dd",
    },
    BundledPackageEntry {
        name: "@clay/markdown",
        version: "0.1.0",
        root: "markdown",
        manifest_fingerprint: "751e54618812c76f",
    },
    BundledPackageEntry {
        name: "@clay/rust",
        version: "0.1.0",
    ...
    BundledPackageEntry {
        ...
        version: "0.1.0",
        root: "typescript",
        manifest_fingerprint: "b4a1a25a0cbc4a48",
    },
];
