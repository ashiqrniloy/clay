...
fn server_public_items_have_api_inventory_entries_or_are_allowlisted() {
    ...
    let allowlisted_infrastructure: BTreeSet<&str> = [
        ...
        // Phase 18.20 language-intelligence and language-server infrastructure
        // is server-internal; public Clay JS API docs cover the facades, not
        // the internal coordinator, registry, process service, and validator
        // types.
        "src/server/language_intelligence.rs::JsLanguageIntelligenceProviderRegistration",
        ...
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::new",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::providers",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::providers_for_feature",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::register_builtin",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::register_package",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::schedule",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::stats",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinator::validate_published_result",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinatorError",
        "src/server/language_intelligence.rs::LanguageIntelligenceCoordinatorStats",
        "src/server/language_intelligence.rs::LanguageIntelligenceDocumentWindow",
        "src/server/language_intelligence.rs::LanguageIntelligenceDocumentWindow::text_len_bytes",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderError",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderFuture",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderMeta::builtin_core",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderMeta::supports_feature",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderMeta::supports_mode",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::get",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::is_empty",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::len",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::list_ordered",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::new",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::providers_for_feature",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::register_builtin",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::register_package",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::remove_older_generations",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::remove_package",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::select_provider",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistry::unregister",
        "src/server/language_intelligence.rs::LanguageIntelligenceProviderRegistryError",
        "src/server/language_intelligence.rs::validate_result",
        "src/server/language_server.rs::LanguageServerError",
        "src/server/language_server.rs::LanguageServerProcessService",
        ...
        "src/server/language_server.rs::LanguageServerSessionId",
        "src/server/language_server.rs::LanguageServerSessionId::as_u64",
        "src/server/language_server.rs::LanguageServerSessionId::from_u64",
        "src/server/language_server.rs::LanguageServerSpawn",
