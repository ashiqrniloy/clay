// @generated by scripts/generate-icon-packs.mjs from packages/icon-sources.json (v2.0.8). Do not edit.
// Host safety fallback: bounded normalized geometry for the 21 core semantic keys.
...
export const FALLBACK_ICONS: Record<string, FallbackIcon> = {
  ...
  "generation.stop": {
    ...
    "paths": [
      {
        "d": "M200.73,40H55.27A15.29,15.29,0,0,0,40,55.27V200.73A15.29,15.29,0,0,0,55.27,216H200.73A15.29,15.29,0,0,0,216,200.73V55.27A15.29,15.29,0,0,0,200.73,40ZM200,200H56V56H200Z"
      }
    ]
  },
  "navigation.back": {
