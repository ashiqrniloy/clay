 ...
 */
export type ActiveTypography = { revision: number, monospace: FontProfile, proportional: FontProfile, ui: FontProfile, 
/**
 ...
 */
export type DesignSystemProvenance = { packageName: string, packageVersion: string, apiPrefix: string, trustDomain: PackageUiTrustDomain, };

/**
 * Resolved UI design system projection consumed by the frontend design-system adapter.
 */
export type DesignSystemSnapshotDto = { specifier: string, schemaVersion: number, generation: number, provenance: DesignSystemProvenance, recipes: { [key in string]: ComponentRecipeDto }, variables: { [key in string]: DesignSystemVariableValueDto }, };
 ...
 */
export type IconPackSnapshotDto = { specifier: string, schemaVersion: number, generation: number, provenance: DesignSystemProvenance, icons: { [key in string]: IconGeometryDto }, };
 ...
 */
export type TypographySnapshotDto = ActiveTypography;
