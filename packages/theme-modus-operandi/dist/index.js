// @clay/theme-modus-operandi — Modus theme for Clay (inert style data).
//
// This theme is pure inert style data: its overrides live in package.json under
// `clay.contributions.textStyles` and `clay.contributions.designTokens` and are parsed by Clay at load. There is no
...
// this theme via `setTheme("@clay/theme-modus-operandi")` in init.js.
export {};
