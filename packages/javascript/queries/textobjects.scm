;; Tree-sitter text objects for JavaScript (Plan 071 task 10). Capture names
;; follow `textobject.<kind>.<scope>`; kinds without an `inner` capture fall
...
(function_expression) @textobject.function.around
(function_expression body: (statement_block) @textobject.function.inner)
(generator_function_declaration) @textobject.function.around
(generator_function) @textobject.function.around
