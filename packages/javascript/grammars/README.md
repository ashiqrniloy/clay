# JavaScript grammar artifact

`javascript.wasm` is the Tree-sitter WebAssembly grammar for JavaScript
(`tree-sitter-javascript`). It is sourced from the upstream
`tree-sitter-javascript` release and is first-party only: Clay loads it as a
