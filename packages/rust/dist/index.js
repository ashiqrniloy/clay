...
export function rustPackageManifest() {
  return {
    ...
    clay: {
      ...
      extensionPoints: [{"id": "rust.completionProviders", "version": 1, "operations": ["append", "replace"], "contributionKinds": ["completionProvider"], "scopes": ["rust.keywords", "rust.snippets"], "summary": "Add or replace rust completion and snippet providers."}, {"id": "rust.languageLayers", "version": 1, "operations": ["append"], "contributionKinds": ["analyzer", "diagnosticSource", "intelligenceProvider", "decorationLayer"], "summary": "Append package-owned analyzers, diagnostics, intelligence, and decoration layers for rust."}, {"id": "rust.commands", "version": 1, "operations": ["append", "replace"], "contributionKinds": ["command"], "scopes": ["rust.toggleLineComment"], "summary": "Add or replace rust commands."}, {"id": "rust.ui", "version": 1, "operations": ["append", "replace"], "contributionKinds": ["componentContribution", "statusItem", "panelContribution"], "scopes": ["rust.status.mode"], "summary": "Add or replace rust status and panel contributions."}, {"id": "rust.grammar", "version": 1, "operations": ["replace"], "contributionKinds": ["grammar"], "scopes": ["rust.rust"], "summary": "Replace the rust grammar, highlights query, and style map."}, {"id": "rust.modePattern", "version": 1, "operations": ["append"], "contributionKinds": ["modePattern"], "summary": "Extend rust file and mode patterns."}],
      contributions: {
