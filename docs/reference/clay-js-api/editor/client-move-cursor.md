...
- Backing Rust/current owner: `src/client_commands.rs::EditorClientCommand` (and `move_paragraph`, `move_first_non_blank`, `move_last_non_blank`, `move_matching_pair`)
