...
Use this API when a user wants to bind a direction-named pane-management chord in `~/.clay/init.js`. New configuration should prefer the canonical `shell.clientSplitPaneHorizontal`; the alias exists for direction-named bindings and help discovery.
