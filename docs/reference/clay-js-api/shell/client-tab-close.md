...
js_facade: runtime/js/shell.js::clientTabClose
...
name: clientTabClose
user_facing_name: Close Tab
summary: "Return the stable bindable command ID for closing the active tab."
owner: client
phase: Phase 22.4
visibility: public
permissions: []
...
Return the stable bindable command ID for closing the active tab.
...
```ts
import { clientTabClose } from "clay:shell";
import { bindKey } from "clay:keybindings";

bindKey("Ctrl+Shift+W", clientTabClose(), { scope: "global" });
```
...
- JS facade: `runtime/js/shell.js::clientTabClose`
