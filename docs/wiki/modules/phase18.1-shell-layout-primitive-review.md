...
- `tests/primitives_docs.rs::phase18_1_shell_layout_primitive_review_records_existing_inventory`
- `tests/primitives_docs.rs::phase18_1_shell_layout_primitive_review_rejects_mode_specific_rust_layout`
- `tests/primitives_docs.rs::phase18_1_shell_layout_primitive_review_records_hot_path_and_security_boundaries`
