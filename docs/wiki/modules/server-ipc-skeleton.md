...
6. `ServerMessage::FileOpenCapabilityIssued` with a single-use token for selected-path UI requests: `OpenSelectedFile` and `AddSelectedWorkspaceRoot`
