...
- `src/client/tests.rs`: `client_receives_sdui_snapshot_event` validates decoded SDUI event delivery and `sdui_button_action_emits_server_intent` validates bounded typed action emission.
