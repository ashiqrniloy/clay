...
- `src/server/connection.rs`: `sdui_actions_and_keybinding_intents_share_command_execution_path` and `package_ui_unregistered_action_is_rejected_by_command_execution` validate that SDUI/package UI actions and keybinding/menu command intents share the Phase 18.8 executor path.
