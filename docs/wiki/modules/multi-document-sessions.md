...
- `src/client/tests.rs`: `client_forwards_document_opened_without_replacing_live_sync_state` validates `DocumentOpened` no longer resets sync at connection layer.
