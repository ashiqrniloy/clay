...
- `tests/editor_intelligence_protocol.rs`: Phase 28 codec compatibility for the protocol version 32 handshake pin, folding, Link/InlayHint `DecorationSet`/`DecorationBatch`, inert `DecorationTarget` click/hover data, completion recency, hover request/results, and bounded malformed-frame rejection.
