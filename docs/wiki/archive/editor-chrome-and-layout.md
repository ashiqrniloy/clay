...
> [React CodeMirror Editor](../modules/react-codemirror-editor.md). Protocol shapes and
...
- [Editor Theme Registry](../modules/editor-theme-registry.md) — chrome color keys, background axis, size ladder.
- [Decoration Transport](../modules/decoration-transport.md) — background fills between selection and text, plus Link/Inlay payloads.
- [Folding Ranges](../modules/folding-ranges.md) — validated ranges, Tree-sitter derivation, client-local collapse, and chevron ownership.
- [Typography Registry and Font Roles](../modules/typography-registry-and-font-roles.md) — size ladder and document line height.
- [Behavior Manifests](../modules/behavior-manifests.md) — `editorRules` schema and per-document manifest layers.
- [Masonry Editor Widget Status Observability](../archive/masonry-editor.md) — editor surface hosting and paint order.
- [Editor Movement, Selection, Caret, Ligatures, and Text Objects](../modules/editor-movement-selection-caret.md) — caret geometry reused by chrome.
