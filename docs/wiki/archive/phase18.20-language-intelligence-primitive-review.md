...
- Patterns: `.agents/skills/clay-execution/references/packages.md`, `authority-boundaries.md`, `extensions-and-ai.md`, `language-capability-sequencing.md`, and `protocol-and-performance.md`.
...
- [Git Discovery Service](../modules/git-discovery-service.md)
