...
- Patterns: `.agents/skills/clay-execution/references/packages.md`, `mode-primitive-first.md`, `protocol-and-performance.md`, and `authority-boundaries.md`.
...
- [Typography Registry and Font Roles](../modules/typography-registry-and-font-roles.md)
