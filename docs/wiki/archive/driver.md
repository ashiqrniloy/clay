...
- [Tabs and Independent Client Views](../modules/tabs-and-clients.md) — the
  multi-connection model the driver orchestrates.
- [Masonry Shell Runtime](../archive/masonry-shell.md) — the shell side
  (`TabChrome` map, tab bar) the driver drives.
- [Multi-Document Sessions](../modules/multi-document-sessions.md) — reconnect
  document identity retention.
- [Pane Document Views](../archive/pane-document-views.md) — per-pane views the
