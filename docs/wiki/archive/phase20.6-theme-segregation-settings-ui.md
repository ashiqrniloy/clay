...
- [Editor Theme Registry](../modules/editor-theme-registry.md) — `StyleRegistry`, `setTheme`, `ActiveTheme`, Phase 20.1 typed design tokens.
- [Configuration Runtime](../modules/configuration-runtime.md) — `init.js` loading, closed `clay:configuration` module, `setPackageOption`.
- [Typography Registry and Font Roles](../modules/typography-registry-and-font-roles.md) — `setTypography`, font profiles, hierarchy.
- [Slot-Aware Package UI](../modules/slot-aware-package-ui.md) — `clay:ui` contribution registry, catalog kinds, fixed panel composition.
- [Persistent Runtime Hot Reload](../modules/persistent-runtime-hot-reload.md) — `RuntimeStateSnapshot` fanout, reload lifecycle.
- [Package Loading](../modules/package-loading.md) — bundled package registration, FNV-1a-64 fingerprints.
