...
- Skill references: `.agents/skills/clay-execution/references/components.md` (conformance contract), `.agents/skills/clay-execution/references/tokens.md` (Rules 7–8)
...
- [Shell Primitives](../archive/shell-primitives.md) — `src/shell/primitives.rs` chrome primitive layer, token-driven paint.
- [Editor Theme Registry](../modules/editor-theme-registry.md) — `StyleRegistry`, `ActiveTheme`, Phase 20.1 typed design tokens, `ResolvedUiTheme`.
- [Slot-Aware Package UI](../modules/slot-aware-package-ui.md) — `clay:ui` contribution registry, component catalog, `ComponentKind` validation.
- [Server-Driven UI](../modules/server-driven-ui.md) — SDUI paint path, `SduiNativeState`, payload budgets.
- [Package Loading](../modules/package-loading.md) — `assemble_package_record` adopted boundary, payload budgets.
- [Third-Party Runtime Authority](../modules/third-party-runtime-authority.md) — two trust domains, inert-data invariants.
- [Maintenance and Validation](../modules/maintenance-validation.md) — drift-guard test patterns.
- [Phase 20.6 Theme Package Segregation](../archive/phase20.6-theme-segregation-settings-ui.md) — canonical default resolution (`apply_theme`/`resolve_canonical_default_theme` now contrast-guarded).
- [Phase 20.4 Core Component Uplift](../archive/phase20.4-core-component-uplift-primitive-review.md) — `component_state_color`/`list_row_fill_color` token→state mapping the contrast floor protects.
...
- [Clay UI Component Catalog (skill)](../../../.agents/skills/clay-execution/references/components.md)
- [Clay Theme Tokens (skill)](../../../.agents/skills/clay-execution/references/tokens.md)
