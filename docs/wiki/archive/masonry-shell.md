...
Phase 22.2 (2026-08-05) wires document views into the pane hosts and makes the shell's focus state drive document routing (see [Pane Document Views](../archive/pane-document-views.md) for the full model):
...
- `src/driver/mod.rs` `Driver` owns `tabs: BTreeMap<ClientId, TabState>`
  ...
  `src/main.rs` — see the [driver module map](../archive/driver.md)). The session
...
- [Pane Document Views](../archive/pane-document-views.md) — per-pane document hosting and routing (22.2)
- [Tabs and Independent Client Views](../modules/tabs-and-clients.md) — the multi-connection model, server registry, lifecycle, reconnect (22.3)
...
- [Shell Primitives](../archive/shell-primitives.md)
...
(see [Pane Document Views](../archive/pane-document-views.md)). The server keeps
...
[Repeatable UI Review Harness](../modules/ui-review-harness.md) and
