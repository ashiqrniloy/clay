...
> Historical native-client record for the GUI wiring portions. The current client path is [Frontend Edit Synchronization](../flows/frontend-edit-synchronization.md) and the bridge session is [Desktop Typed Bridge](../modules/desktop-typed-bridge.md).
