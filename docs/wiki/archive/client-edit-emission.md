...
> Historical native-client record. The Masonry editor and `EditorWidget` were removed in Plan 097 Phase 12; the current keystroke path is [Frontend Edit Synchronization](../flows/frontend-edit-synchronization.md).
