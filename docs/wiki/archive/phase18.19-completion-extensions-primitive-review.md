...
- Patterns: `.agents/skills/clay-execution/references/packages.md`, `authority-boundaries.md`, `protocol-and-performance.md`, `clay-js-api-naming.md`, `clay-js-api-schema.md`, `configuration-system.md`.
...
- [Transient Menu and Command Execution Primitive Review](../archive/phase18.8-transient-menu-command-execution-primitive-review.md)
