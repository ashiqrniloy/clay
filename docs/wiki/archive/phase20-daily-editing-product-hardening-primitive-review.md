...
| Theme system | Phase 18.15 `StyleRegistry`, `ActiveTheme`, `theme.setTheme`, Gruvbox Material themes, typography profiles | Inert theme packages, bootstrap/live theme install, vocabulary-token paint, status/chrome colors | **Satisfied by Phase 18.15.** Phase 20 verification closed: status/chrome already resolve through `StyleRegistry`; added theme-label observability + status-chrome AA contrast checks only — do not rebuild themes |
...
- [Persistent Runtime Hot Reload](../modules/persistent-runtime-hot-reload.md)
- [Phase 19 Hot Reload and Behavior Update Primitive Review](../archive/phase19-hot-reload-behavior-update-primitive-review.md)
- [Masonry Editor Widget Status Observability](../archive/masonry-editor.md)
- [Client File Dialog Backend](../modules/client-file-dialog.md)
- [Server File Workspace Model](../modules/server-file-workspace.md)
- [Server Document State](../modules/server-document-state.md)
- [Editor Theme Registry](../modules/editor-theme-registry.md)
- [Transient Menu Session](../modules/transient-menu-session.md)
- [Workspace Discovery and File Browser](../modules/workspace-file-browser.md)
