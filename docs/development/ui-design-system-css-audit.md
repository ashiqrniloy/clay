...
| `.listRow` | `gap` | `var(--clay-ds-list-default-item-rest-gap, 2px)` | Non-Color UI Design-System Recipe | `list.default.row.rest.gap` | `2px` | rest | UI Design System | Align variable name to `list.default.row.*` in Task 3 |
| `.listRow` | `background` | `var(--clay-ds-list-default-item-rest-background-color, var(--clay-surface-list))` | Active Content-Theme Color Role | `surface.list` | Active Theme | rest | Content Theme | Align variable name to `list.default.row.*` in Task 3 |
| `.listRow` | `color` | `var(--clay-ds-list-default-item-rest-text-color, var(--clay-text-primary))` | Active Content-Theme Color Role | `text.primary` | Active Theme | rest | Content Theme | Align variable name to `list.default.row.*` in Task 3 |
| `.listRow` | `border-bottom` | `var(--clay-ds-list-default-item-rest-border-width, 1px) solid var(--clay-ds-list-default-item-rest-border-color, var(--clay-border-hairline))` | Non-Color UI Design-System Recipe | `list.default.row.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Align variable in Task 3 |
| `.listRow` | `padding` | `var(--clay-ds-list-default-item-rest-padding, var(--clay-spacing-xs) var(--clay-spacing-sm))` | Non-Color UI Design-System Recipe | `list.default.row.rest.padding` | `spacing.xs` `spacing.sm` | rest | UI Design System | Align variable in Task 3 |
| `.listRow` | `cursor` | `pointer` | Structural Layout | n/a | Host | rest | React Host | Retained (interaction) |
| `.listRow[data-hovered]` | `background` | `var(--clay-ds-list-default-item-hover-background-color, var(--clay-surface-hover))` | Active Content-Theme Color Role | `surface.hover` | Active Theme | `data-hovered` | Content Theme | Align variable in Task 3 |
| `.listRow[data-pressed]` | `background` | `var(--clay-ds-list-default-item-active-background-color, var(--clay-surface-active))` | Active Content-Theme Color Role | `surface.active` | Active Theme | `data-pressed` | Content Theme | Align variable in Task 3 |
| `.listRow[data-focused]` | `outline` | `var(--clay-ds-list-default-item-focus-outline-width, 2px) solid var(--clay-ds-list-default-item-focus-outline-color, var(--clay-focus-ring))` | Accessibility Override | `focus.ring` | `focus.ring` (2px solid) | `data-focused` | React Aria / DS | Align variable in Task 3 |
| `.listRow[data-focused]` | `outline-offset` | `var(--clay-ds-list-default-item-focus-outline-offset, -2px)` | Non-Color UI Design-System Recipe | `list.default.row.focus.outlineOffset` | `-2px` | `data-focused` | UI Design System | Align variable in Task 3 |
| `.listRow[data-selected]` | `background` | `var(--clay-ds-list-default-item-selected-background-color, var(--clay-surface-selected))` | Active Content-Theme Color Role | `surface.selected` | Active Theme | `data-selected` | Content Theme | Align variable in Task 3 |
| `.listRow[data-disabled]` | `color` | `var(--clay-ds-list-default-item-disabled-text-color, var(--clay-text-disabled))` | Active Content-Theme Color Role | `text.disabled` | Active Theme | `data-disabled` | Content Theme | Align variable in Task 3 |
| `.listRow[data-disabled]` | `opacity` | `var(--clay-ds-list-default-item-disabled-opacity, var(--clay-opacity-disabled))` | Non-Color UI Design-System Recipe | `list.default.row.disabled.opacity` | `opacity.disabled` (0.55) | `data-disabled` | UI Design System | Align variable in Task 3 |
...
| `.dialog` | `background` | `var(--clay-ds-modal-default-surface-rest-background-color, var(--clay-surface-overlay))` | Active Content-Theme Color Role | `surface.overlay` | Active Theme | rest | Content Theme | Align variable to `modal.default.dialog.*` in Task 3 |
| `.dialog` | `color` | `var(--clay-ds-modal-default-surface-rest-text-color, var(--clay-text-primary))` | Active Content-Theme Color Role | `text.primary` | Active Theme | rest | Content Theme | Align variable in Task 3 |
| `.dialog` | `border` | `var(--clay-ds-modal-default-surface-rest-border-width, 1px) solid var(--clay-ds-modal-default-surface-rest-border-color, var(--clay-border-strong))` | Non-Color UI Design-System Recipe | `modal.default.dialog.rest.border*` | `border.strong` (1px) | rest | UI Design System / Theme | Align variable in Task 3 |
| `.dialog` | `border-radius` | `var(--clay-ds-modal-default-surface-rest-border-radius, 0)` | Non-Color UI Design-System Recipe | `modal.default.dialog.rest.borderRadius` | `0` | rest | UI Design System | Align variable in Task 3 |
| `.dialog` | `box-shadow` | `var(--clay-ds-modal-default-surface-rest-shadow, none)` | Non-Color UI Design-System Recipe | `modal.default.dialog.rest.shadow` | `none` | rest | UI Design System | Align variable in Task 3 |
| `.dialog` | `backdrop-filter` | `blur(var(--clay-ds-modal-default-surface-rest-backdrop-blur, 0px)) saturate(var(--clay-ds-modal-default-surface-rest-backdrop-saturate, 1))` | Non-Color UI Design-System Recipe | `modal.default.dialog.rest.backdropBlur` / `backdropSaturate` | `0px` / `1.0` | rest | UI Design System | Align variable in Task 3 |
...
| `.dialog` | `padding` | `var(--clay-ds-modal-default-surface-rest-padding, var(--clay-spacing-md, 16px))` | Non-Color UI Design-System Recipe | `modal.default.dialog.rest.padding` | `spacing.md` (16px) | rest | UI Design System | Align variable in Task 3 |
...
| `.field` | `gap` | `var(--clay-ds-text-input-default-root-rest-gap, var(--clay-spacing-xxs, 4px))` | Non-Color UI Design-System Recipe | `textInput.default.field.rest.gap` | `spacing.xxs` (4px) | rest | UI Design System | Retained / verified |
...
| `.input` | `background` | `var(--clay-ds-text-input-default-root-rest-background-color, var(--clay-surface-control))` | Active Content-Theme Color Role | `surface.control` | Active Theme | rest | Content Theme | Retained / verified |
| `.input` | `color` | `var(--clay-ds-text-input-default-root-rest-text-color, var(--clay-text-primary))` | Active Content-Theme Color Role | `text.primary` | Active Theme | rest | Content Theme | Retained / verified |
| `.input` | `border` | `var(--clay-ds-text-input-default-root-rest-border-width, 2px) solid var(--clay-ds-text-input-default-root-rest-border-color, var(--clay-border-subtle))` | Non-Color UI Design-System Recipe | `textInput.default.input.rest.border*` | `border.subtle` (2px) | rest | UI Design System / Theme | Retained / verified |
| `.input` | `border-radius` | `var(--clay-ds-text-input-default-root-rest-border-radius, 0)` | Non-Color UI Design-System Recipe | `textInput.default.input.rest.borderRadius` | `0` | rest | UI Design System | Retained / verified |
| `.input` | `padding` | `var(--clay-ds-text-input-default-root-rest-padding, var(--clay-spacing-xs, 8px))` | Non-Color UI Design-System Recipe | `textInput.default.input.rest.padding` | `spacing.xs` (8px) | rest | UI Design System | Retained / verified |
...
| `.input` | `box-shadow` | `var(--clay-ds-text-input-default-root-rest-shadow, none)` | Non-Color UI Design-System Recipe | `textInput.default.input.rest.shadow` | `none` | rest | UI Design System | Retained / verified |
| `.input` | `transition` | `border-color/background-color var(--clay-ds-text-input-default-root-rest-transition-duration, 100ms) linear` | Non-Color UI Design-System Recipe | `textInput.default.input.rest.transitionDuration` | `motion.fast` (100ms) | rest | UI Design System | Retained / verified |
...
| `.input[data-focused]` | `border-color` | `var(--clay-ds-text-input-default-root-focus-border-color, var(--clay-border-focus))` | Active Content-Theme Color Role | `border.focus` | Active Theme | `data-focused` | Content Theme | Retained / verified |
| `.input[data-focused]` | `outline` | `none` | Accessibility Override | n/a | Host | `data-focused` | React Aria | Retained (border-focus is the active ring) |
| `.error` | `border-color` | `var(--clay-ds-text-input-default-root-invalid-border-color, var(--clay-diagnostic-error))` | Active Content-Theme Color Role | `diagnostic.error` | Active Theme | `data-invalid` | Content Theme | Retained / verified |
...
| `.input[data-disabled]` | `background` | `var(--clay-ds-text-input-default-root-disabled-background-color, var(--clay-surface-disabled))` | Active Content-Theme Color Role | `surface.disabled` | Active Theme | `data-disabled` | Content Theme | Retained / verified |
| `.input[data-disabled]` | `color` | `var(--clay-ds-text-input-default-root-disabled-text-color, var(--clay-text-disabled))` | Active Content-Theme Color Role | `text.disabled` | Active Theme | `data-disabled` | Content Theme | Retained / verified |
| `.input[data-disabled]` | `opacity` | `var(--clay-ds-text-input-default-root-disabled-opacity, var(--clay-opacity-disabled))` | Non-Color UI Design-System Recipe | `textInput.default.input.disabled.opacity` | `opacity.disabled` (0.55) | `data-disabled` | UI Design System | Retained / verified |
...
| `.footer` | `gap` | `var(--clay-spacing-sm, 12px)` | Non-Color UI Design-System Recipe | `statusBar.default.root.rest.gap` | `spacing.sm` (12px) | rest | UI Design System | Map to `statusBar.default.root.rest.gap` in Task 4 |
| `.footer` | `border-top` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-hairline)` | Non-Color UI Design-System Recipe | `statusBar.default.root.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Map to `statusBar.default.root.rest.border*` in Task 4 |
| `.footer` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` | Active Theme | rest | Content Theme | Map to `statusBar.default.root.rest.backgroundColor` in Task 4 |
| `.footer` | `color` | `var(--clay-text-muted)` | Active Content-Theme Color Role | `text.muted` | Active Theme | rest | Content Theme | Map to `statusBar.default.root.rest.textColor` in Task 4 |
| `.footer` | `padding` | `var(--clay-spacing-xxs, 4px) var(--clay-spacing-sm, 12px)` | Non-Color UI Design-System Recipe | `statusBar.default.root.rest.padding` | `spacing.xxs` `spacing.sm` | rest | UI Design System | Map to `statusBar.default.root.rest.padding` in Task 4 |
...
### 4.8 `frontend/src/app/layout/tab-bar.module.css`
...
| `.tabList` | `background` | `var(--clay-surface-main)` | Active Content-Theme Color Role | `surface.main` | Active Theme | rest | Content Theme | Retained / verified |
...
| `.chat` | `background` | `var(--clay-surface-main)` | Active Content-Theme Color Role | `surface.main` | Active Theme | rest | Content Theme | Map to `chatPanel.default.root.rest.backgroundColor` in Task 4 |
| `.chat` | `color` | `var(--clay-text-main)` (Typo in code) | Unjustified Literal | `text.primary` | Active Theme | rest | Content Theme | Fix typo to `var(--clay-text-primary)` in Task 4 |
| `.chat` | `border` | `1px solid var(--clay-border-hairline)` | Unjustified Literal | `chatPanel.default.root.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Migrate to `chatPanel.default.root.rest.border*` recipe in Task 4 |
| `.header` | `display` | `grid` | Structural Layout | n/a | Host | rest | React Host | Retained (header layout) |
| `.header` | `gap` | `var(--clay-spacing-xs)` | Non-Color UI Design-System Recipe | `chatPanel.default.header.rest.gap` | `spacing.xs` | rest | UI Design System | Map to `chatPanel.default.header.rest.gap` in Task 4 |
| `.header` | `padding` | `var(--clay-spacing-lg) var(--clay-spacing-lg) var(--clay-spacing-md)` | Non-Color UI Design-System Recipe | `chatPanel.default.header.rest.padding` | `spacing.lg` `spacing.md` | rest | UI Design System | Map to `chatPanel.default.header.rest.padding` in Task 4 |
| `.header` | `border-bottom` | `2px solid var(--clay-border-strong)` | Unjustified Literal | `chatPanel.default.header.rest.border*` | `border.strong` (2px) | rest | UI Design System / Theme | Migrate to `chatPanel.default.header.rest.border*` recipe in Task 4 |
...
| `.actions` | `border-bottom` | `1px solid var(--clay-border-hairline)` | Non-Color UI Design-System Recipe | `chatPanel.default.header.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Migrate to recipe in Task 4 |
| `.transcriptScroll` | `overflow-y` | `auto` | Structural Layout | n/a | Host | rest | React Host | Retained (scrolling containment) |
| `.transcriptScroll` | `padding` | `var(--clay-spacing-md) var(--clay-spacing-lg)` | Non-Color UI Design-System Recipe | `chatPanel.default.transcript.rest.padding` | `spacing.md` `spacing.lg` | rest | UI Design System | Map to `chatPanel.default.transcript.rest.padding` in Task 4 |
| `.transcriptScroll` | `gap` | `var(--clay-spacing-sm)` | Non-Color UI Design-System Recipe | `chatPanel.default.transcript.rest.gap` | `spacing.sm` | rest | UI Design System | Map to `chatPanel.default.transcript.rest.gap` in Task 4 |
| `.transcriptScroll` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` | Active Theme | rest | Content Theme | Map to `chatPanel.default.transcript.rest.backgroundColor` in Task 4 |
| `.user` | `justify-self` | `end` | Structural Layout | n/a | Host | rest | React Host | Retained (message alignment) |
| `.user` | `padding` | `var(--clay-spacing-sm) var(--clay-spacing-md)` | Non-Color UI Design-System Recipe | `chatPanel.default.userMessage.rest.padding` | `spacing.sm` `spacing.md` | rest | UI Design System | Map to `chatPanel.default.userMessage.rest.padding` in Task 4 |
| `.user` | `border` | `1px solid var(--clay-border-strong)` | Unjustified Literal | `chatPanel.default.userMessage.rest.border*` | `border.strong` (1px) | rest | UI Design System / Theme | Migrate to recipe in Task 4 |
| `.user` | `background` | `var(--clay-surface-badge)` | Active Content-Theme Color Role | `surface.badge` | Active Theme | rest | Content Theme | Map to `chatPanel.default.userMessage.rest.backgroundColor` in Task 4 |
| `.assistant` | `justify-self` | `start` | Structural Layout | n/a | Host | rest | React Host | Retained (message alignment) |
| `.assistant` | `padding` | `var(--clay-spacing-sm) var(--clay-spacing-md)` | Non-Color UI Design-System Recipe | `chatPanel.default.assistantMessage.rest.padding` | `spacing.sm` `spacing.md` | rest | UI Design System | Map to `chatPanel.default.assistantMessage.rest.padding` in Task 4 |
| `.assistant` | `border-left` | `2px solid var(--clay-accent-primary)` | Unjustified Literal | `chatPanel.default.assistantMessage.rest.border*` | `accent.primary` (2px) | rest | UI Design System / Theme | Migrate to recipe in Task 4 |
...
| `.surface` | `gap` | `var(--clay-spacing-sm, 12px)` | Non-Color UI Design-System Recipe | `commandCentre.default.dialog.rest.gap` | `spacing.sm` (12px) | rest | UI Design System | Map to `commandCentre.default.dialog.rest.gap` in Task 4 |
| `.surface` | `width` | `min(calc(var(--clay-dimension-overlay-centered-width) - ...), calc(90vw - ...))` | Structural Layout | `dimension.overlay.centered.width` | Host (640px) | rest | React Host | Retained (centered overlay width constraint) |
...
| `.empty` | `border-top` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-subtle)` | Non-Color UI Design-System Recipe | `commandCentre.default.empty.rest.border*` | `border.subtle` (1px) | rest | UI Design System / Theme | Map to `commandCentre.default.empty.rest.border*` in Task 4 |
| `.status` | `color` | `var(--clay-text-muted)` | Active Content-Theme Color Role | `text.muted` | Active Theme | rest | Content Theme | Map to `commandCentre.default.status.rest.textColor` in Task 4 |
...
| `.host` | `background` | `var(--clay-surface-main)` | Active Content-Theme Color Role | `surface.main` | Active Theme | rest | Content Theme | Retained / verified |
| `.chrome` | `display` | `flex` | Structural Layout | n/a | Host | rest | React Host | Retained (editor chrome bar layout) |
| `.chrome` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` | Active Theme | rest | Content Theme | Map to `editorChrome.default.gutter.rest.backgroundColor` in Task 4 |
| `.chrome` | `border-bottom` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-hairline)` | Non-Color UI Design-System Recipe | `editorChrome.default.gutter.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Map to recipe in Task 4 |
...
| `.canvas :global(.cm-gutters)` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` / `panelBg` | CodeMirror Theme | rest | CodeMirror Theme | Retained (CM theme authority) |
| `.canvas :global(.cm-gutters)` | `color` | `var(--clay-text-muted)` | Active Content-Theme Color Role | `text.muted` / `gutterFg` | CodeMirror Theme | rest | CodeMirror Theme | Retained (CM theme authority) |
| `.canvas :global(.cm-gutters)` | `border-right` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-hairline)` | Non-Color UI Design-System Recipe | `editorChrome.default.gutter.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Retained / verified |
| `.canvas :global(.cm-activeLine)` | `background` | `var(--clay-surface-hover)` | Active Content-Theme Color Role | `surface.hover` / `lineHighlight` | CodeMirror Theme | rest | CodeMirror Theme | Retained (CM theme authority) |
| `.canvas :global(.cm-tooltip)` | `background` | `var(--clay-surface-overlay)` | Active Content-Theme Color Role | `surface.overlay` | Active Theme | rest | Content Theme | Retained (CM tooltip) |
...
| `.left` | `border-right` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-subtle)` | Non-Color UI Design-System Recipe | `panel.fixed.root.rest.border*` | `border.subtle` (1px) | rest | UI Design System / Theme | Map to `panel.fixed.root.rest.border*` in Task 4 |
...
| `.status` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` | Active Theme | rest | Content Theme | Map to `statusBar.default.root.rest.backgroundColor` in Task 4 |
| `.status` | `border-top` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-hairline)` | Non-Color UI Design-System Recipe | `statusBar.default.root.rest.border*` | `border.hairline` (1px) | rest | UI Design System / Theme | Map to `statusBar.default.root.rest.border*` in Task 4 |
...
| `.panel` | `background` | `var(--clay-surface-panel)` | Active Content-Theme Color Role | `surface.panel` | Active Theme | rest | Content Theme | Map to `settingsPanel.default.panel.rest.backgroundColor` in Task 4 |
| `.panel` | `color` | `var(--clay-text-primary)` | Active Content-Theme Color Role | `text.primary` | Active Theme | rest | Content Theme | Map to `settingsPanel.default.panel.rest.textColor` in Task 4 |
| `.panel` | `border-left` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-subtle)` | Non-Color UI Design-System Recipe | `settingsPanel.default.panel.rest.border*` | `border.subtle` (1px) | rest | UI Design System / Theme | Map to `settingsPanel.default.panel.rest.border*` in Task 4 |
| `.heading` | `border-bottom` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-subtle)` | Non-Color UI Design-System Recipe | `settingsPanel.default.heading.rest.border*` | `border.subtle` (1px) | rest | UI Design System / Theme | Map to `settingsPanel.default.heading.rest.border*` in Task 4 |
| `.actions` | `border-top` | `var(--clay-dimension-border-hairline, 1px) solid var(--clay-border-subtle)` | Non-Color UI Design-System Recipe | `settingsPanel.default.actions.rest.border*` | `border.subtle` (1px) | rest | UI Design System / Theme | Map to `settingsPanel.default.actions.rest.border*` in Task 4 |
...
| File | Selector / State | Property | Current Value | Classification | Target Recipe Key / Theme Role | Fallback Source | Owner | Migration Plan |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `pane-tree.module.css` | `.group` | `background` | `var(--clay-border-hairline)` | Active Content-Theme Color Role | `border.hairline` | Active Theme | Content Theme | Retained / verified |
| `pane-tree.module.css` | `.pane` | `background` | `var(--clay-surface-main)` | Active Content-Theme Color Role | `surface.main` | Active Theme | Content Theme | Map to `paneSplitTree.default.pane.rest.backgroundColor` in Task 4 |
| `pane-tree.module.css` | `.pane.active` | `outline-color` | `var(--clay-border-focus)` | Active Content-Theme Color Role | `border.focus` | Active Theme | Content Theme | Retained / verified |
| `pane-tree.module.css` | `.separator` | `background` | `var(--clay-border-strong)` | Active Content-Theme Color Role | `border.strong` | Active Theme | Content Theme | Map to `paneSplitTree.default.handle.rest.backgroundColor` in Task 4 |
| `pane-tree.module.css` | `.separator` | `flex` | `0 0 var(--clay-dimension-border-thin, 2px)` | Non-Color UI Design-System Recipe | `paneSplitTree.default.handle.rest.borderWidth` | `dimension.border.thin` (2px) | UI Design System | Retained / verified |
| `pane-tree.module.css` | `.separator:focus-visible` | `outline` | `2px solid var(--clay-focus-ring)` | Accessibility Override | `focus.ring` (2px) | React Aria | Retained / verified |
...
| `tokens.css` | `:root` | `--clay-ds-*` (18 recipe variables) | Default recipe fallbacks | Non-Color UI Design-System Recipe | Baseline fallbacks | Bootstrap snapshot | Rust Design System Resolver | Retained as instant bootstrap fallback |
