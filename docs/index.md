...
- [clientFocusPanePrev](reference/clay-js-api/shell/client-focus-pane-prev.md) — `clay.shell.clientFocusPanePrev`
- [clientResizePaneLeft](reference/clay-js-api/shell/client-resize-pane-left.md) — `clay.shell.clientResizePaneLeft`
- [clientResizePaneRight](reference/clay-js-api/shell/client-resize-pane-right.md) — `clay.shell.clientResizePaneRight`
- [clientResizePaneUp](reference/clay-js-api/shell/client-resize-pane-up.md) — `clay.shell.clientResizePaneUp`
- [clientResizePaneDown](reference/clay-js-api/shell/client-resize-pane-down.md) — `clay.shell.clientResizePaneDown`
- [clientMovePaneNext](reference/clay-js-api/shell/client-move-pane-next.md) — `clay.shell.clientMovePaneNext`
- [clientMovePanePrev](reference/clay-js-api/shell/client-move-pane-prev.md) — `clay.shell.clientMovePanePrev`
- [setPaneFocusPolicy](reference/clay-js-api/shell/set-pane-focus-policy.md) — `clay.shell.setPaneFocusPolicy`
- [clientTabNext](reference/clay-js-api/shell/client-tab-next.md) — `clay.shell.clientTabNext`
- [clientTabPrev](reference/clay-js-api/shell/client-tab-prev.md) — `clay.shell.clientTabPrev`
- [clientTabNew](reference/clay-js-api/shell/client-tab-new.md) — `clay.shell.clientTabNew`
- [clientTabClose](reference/clay-js-api/shell/client-tab-close.md) — `clay.shell.clientTabClose`
- [clientTabMoveLeft](reference/clay-js-api/shell/client-tab-move-left.md) — `clay.shell.clientTabMoveLeft`
- [clientTabMoveRight](reference/clay-js-api/shell/client-tab-move-right.md) — `clay.shell.clientTabMoveRight`
- [clientTabActivate](reference/clay-js-api/shell/client-tab-activate.md) — `clay.shell.clientTabActivate`
- [clientTabMoveTo](reference/clay-js-api/shell/client-tab-move-to.md) — `clay.shell.clientTabMoveTo`
