...
- Not this plan: the wiki/graft knowledge binding still has no configuration persistence, so a restarted daemon loses an enabled wiki (recorded in the manual-test pass; plan 142 territory).
